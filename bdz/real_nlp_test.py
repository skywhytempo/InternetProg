...
#Проблема - модель также очень высоко оценивает страницы про LOB, BLOB, размер БД, большие таблицы и импорт больших SQL-файлов, то есть цепляется за слово “большие” и за Oracle, хотя это уже другая тема.

#Решение - добавить ограничительные правила
